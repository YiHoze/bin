...
tex = 
	...
	`\numbers{\1}
	`\end{document}
cmd_output = numbers.cmd
cmd = 
	ltx.py numbers.tex
	pdfcrop numbers.pdf @@@.pdf
	rem pdftk @@@.pdf burst
...
compiler = -c
tex_output = shooting_target.tex
tex = 
	`\documentclass{minimal}
...
tex = 
	...
	\end{document}
cmd_output = old_persian.cmd
cmd = 
	teckit_compile.exe old_persian.map
	ltx.py old_persian -v
map_output = old_persian.map
map = 
...
[Steve]
description = The commencement speech addressed by Steve Jobs at Standford University in 2005.
tex_output = SteveSpeech.tex
tex = 
	\documentclass{article}
	...
	\end{document} %%'
cmd_output = SteveSpeech.cmd
cmd = 
	myscript.py webimage
...
[critic]
description = A criticism of an exhibition of art
compiler = -c
tex_output = we_against_you.tex
tex = 
	\documentclass[korean, Noto]{hzguide}
...
[oesol]
description = Oesol script
compiler = -c
tex_output = oesolscript.tex
tex = 
	\documentclass[a4paper]{article}
	\usepackage{kotex}
	...
	\end{document}
style_output = oesolscript.sty
style = 
	`\ProvidesPackage{oesolscript}[2020/05/26 v0.3.3]
...
cmd_output = graphviz.cmd
cmd = 
	dot -T pdf latex_process.gv -o latex_process.pdf
	ltx.py graphviz.tex -v
tex_output = graphviz.tex
tex = 
	`\documentclass[a4paper]{article}
	`\usepackage{graphicx}
	`\begin{document}
	...
	`\end{verbatim}
	`\end{document}
graphviz_output = latex_process.gv
graphviz = 
	`digraph G {
	`	 margin=0;
	`    rankdir=TB;
